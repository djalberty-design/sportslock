...
import { Beaker, Flame, Snowflake, Target } from "lucide-react";
          ...
          <div key={i} className="flex flex-col md:flex-row items-start md:items-center justify-between p-4 rounded-xl border border-line bg-panel hover:border-primary/50 transition-colors shadow-sm">
            <div className="flex flex-col mb-3 md:mb-0">
              ...
              {p.scoreNote && p.scoreNote.includes("[ALPHA]") && (
                <div className="mt-2 flex items-center gap-1.5 rounded bg-primary/10 px-2 py-1 text-xs font-semibold text-primary w-fit">
            ...
            <div className="flex items-center gap-6">
              <div className="flex flex-col items-end">
                <span className="text-xs text-muted uppercase">Confidence</span>
              ...
              <div className="flex flex-col items-end">
                <span className="text-xs text-muted uppercase">Value (EV)</span>
